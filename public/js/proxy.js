document.addEventListener('DOMContentLoaded', function() {
    ...
    function showPopup(proxyType) {
        ...
        if (proxyType === 'openProxy') {
            proxyInfo.innerHTML = "<h2>Proxy is opening soon, read if you have any issues.</h2><p>This proxy is better for media, social media, and (some) games. If you are having any issues, click the help button, or </p>";
            ...
            proxyInfo.innerHTML = "<h2>Better Proxy is opening soon, read if you have any issues.</h2><p>This proxy is better for gaming, use the other proxy for media. (watching videos/movies). If you are having any issues, click the help button, or </p>";
            proxyLink.innerHTML = '<a href="https://docs.google.com/forms/d/e/1FAIpQLSdKy-YstHvXOqCakld55_PzHXU0tqPVimXVBbdwCVHVE3ccqw/viewform" target="_blank" style="color: #ff6600;">File an issue</a>';
